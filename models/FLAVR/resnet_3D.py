...
class BasicStem(nn.Sequential):
    ...
    def __init__(self, img_channels=3):
        super().__init__(
            nn.Conv3d(img_channels, 64, kernel_size=(3, 7, 7), stride=(1, 2, 2),
...
class VideoResNet(nn.Module):
    ...
    def __init__(self, block, conv_makers, layers,
                 stem, img_channels=3, zero_init_residual=False):
        ...
        self.stem = stem(img_channels=img_channels)
...
def unet_18(pretrained=False, bn=False, progress=True, img_channels=3, **kwargs):
    """
    ...
    return _video_resnet('r3d_18',
                         ...
                         layers=[2, 2, 2, 2],
                         stem=BasicStem, img_channels=img_channels, **kwargs)
